...
La route valide le minimum, l'unicité de la référence et crédite le wallet dans une transaction SQL.
...
Une route technique `/api/v1/test-momo` teste le contact MTN MoMo. Elle doit être protégée ou retirée en production.
