...
import { useAppDispatch, useAppSelector } from '@/stores/hooks'; // Ajuste le chemin selon ton architecture
...
export default function OrderListScreen() {
    ...
    return (
        <View style={styles.container}>
            ...
            {/* Liste des commandes filtrées dynamiquement */}
            <FlatList
                data={orders}
                ...
                renderItem={({ item }) => (
                    <View style={styles.orderCard}>
                        {/* Le carré vert clair de ta maquette */}
