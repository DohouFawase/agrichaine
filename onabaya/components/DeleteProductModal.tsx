...
export default function DeleteProductModal({
    ...
    const stallX      = useRef(new Animated.Value(0)).current;
        ...
        <Modal visible={visible} transparent animationType="none" onRequestClose={handleCancel}>
            ...
            <Animated.View style={[styles.sheet, { transform: [{ translateY: slideY }] }]}>
                ...
                <View style={styles.sceneWrap}>
                    ...
                    {/* Vendor */}
                    <Animated.View style={[styles.vendor, { transform: [{ translateY: vendorY }] }]}>
                ...
                <Text style={styles.title}>Retirer ce produit ?</Text>
                <Text style={styles.subtitle}>
                    {productName ? `"${productName}" sera retiré du marché.\n` : 'Ce produit sera retiré du marché.\n'}
                    Le vendeur rentre à la maison.
                </Text>
                ...
                <View style={styles.btnRow}>
                    ...
                    <TouchableOpacity style={[styles.btn, styles.btnConfirm]} onPress={handleConfirm} activeOpacity={0.7}>
                        <Text style={styles.btnConfirmText}>Supprimer</Text>
                    </TouchableOpacity>
                </View>
            </Animated.View>
        </Modal>
